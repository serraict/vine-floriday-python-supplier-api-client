...
class PackingConfiguration(object):
    ...
    def __init__(self, primary=None, pieces_per_package=None, package=None, packages_per_layer=None, layers_per_load_carrier=None, load_carrier=None, photo_url=None, allowed_customer_organization_ids=None):  # noqa: E501
