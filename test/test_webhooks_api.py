...
from floriday_supplier_client.api.webhooks_api import WebhooksApi  # noqa: E501
...
class TestWebhooksApi(unittest.TestCase):
    ...
    def test_add_webhook_subscription(self):
        """Test case for add_webhook_subscription
