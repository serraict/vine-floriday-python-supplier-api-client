# swagger_client.BundledOffersApi
...
api_instance = swagger_client.BundledOffersApi(swagger_client.ApiClient(configuration))
body = swagger_client.AddBundledOffer() # AddBundledOffer | 
...
# create an instance of the API class
api_instance = swagger_client.BundledOffersApi(swagger_client.ApiClient(configuration))
body = swagger_client.EditBundledOffer() # EditBundledOffer | 
bundled_offer_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
