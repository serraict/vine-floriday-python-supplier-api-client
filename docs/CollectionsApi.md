...
body = swagger_client.CollectionCreate() # CollectionCreate | 
...
# create an instance of the API class
api_instance = swagger_client.CollectionsApi(swagger_client.ApiClient(configuration))
body = swagger_client.CollectionTradeItemIds() # CollectionTradeItemIds | 
...
# create an instance of the API class
api_instance = swagger_client.CollectionsApi(swagger_client.ApiClient(configuration))
body = swagger_client.CollectionUpdate() # CollectionUpdate | 
collection_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
