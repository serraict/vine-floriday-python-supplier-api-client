...
[**edit_clock_supply_line**](AuctionApi.md#edit_clock_supply_line) | **PUT** /clock-supply-lines/{supplyLineId} | clock-supply:write - Updates a V2 clock sales supply line.
...
# **add_clock_supply_line**
> add_clock_supply_line(body)

clock-supply:write - Adds a clock sales supply line with optional clock presales supply line.

In the current phase, this endpoint is only intended to indicate clock supply that is already available at FloraHolland stock locations (V&O). So there is always a goods movement preceding this clock allocation.
...
# create an instance of the API class
api_instance = floriday_supplier_client.AuctionApi(floriday_supplier_client.ApiClient(configuration))
body = floriday_supplier_client.AddClockSupplyLine() # AddClockSupplyLine | 

try:
    # clock-supply:write - Adds a clock sales supply line with optional clock presales supply line.
    api_instance.add_clock_supply_line(body)
except ApiException as e:
    print("Exception when calling AuctionApi->add_clock_supply_line: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**AddClockSupplyLine**](AddClockSupplyLine.md)|  | 
...
> edit_clock_supply_line(body, supply_line_id)

clock-supply:write - Updates a V2 clock sales supply line.

Allows editing of clock supply which has been created with the V2 endpoint. Updates the underlying fulfillment request with the newly chosen number of packages. Only unfulfilled packages can be removed. Onboarded daytrade supply can only be changed until 16:00.
...
# create an instance of the API class
api_instance = floriday_supplier_client.AuctionApi(floriday_supplier_client.ApiClient(configuration))
body = floriday_supplier_client.EditClockSupplyLine() # EditClockSupplyLine | 
supply_line_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 

try:
    # clock-supply:write - Updates a V2 clock sales supply line.
    api_instance.edit_clock_supply_line(body, supply_line_id)
except ApiException as e:
    print("Exception when calling AuctionApi->edit_clock_supply_line: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**EditClockSupplyLine**](EditClockSupplyLine.md)|  | 
 **supply_line_id** | [**str**](.md)|  | 
...
> str get_fulfillment_request_id_by_daytrade_clock_supply_line_by_id(supply_line_id)

supply:read - Returns the ID for the fulfillment request which is created for the supply lines created through the V2 flow for onboarded and offboarded daytrade suppliers.

Only available in the 2026v1 to help make the migration to sales strategies.
...
try:
    # supply:read - Returns the ID for the fulfillment request which is created for the supply lines created through the V2 flow for onboarded and offboarded daytrade suppliers.
    api_response = api_instance.get_fulfillment_request_id_by_daytrade_clock_supply_line_by_id(supply_line_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AuctionApi->get_fulfillment_request_id_by_daytrade_clock_supply_line_by_id: %s\n" % e)
```
...
# **get_fulfillment_request_id_by_sales_strategy_presales_order_id**
> str get_fulfillment_request_id_by_sales_strategy_presales_order_id(sales_order_id)

supply:read - Returns the ID for the fulfillment request which is created for the sales order placed on sales strategy based presales supply.
...
try:
    # supply:read - Returns the ID for the fulfillment request which is created for the sales order placed on sales strategy based presales supply.
    api_response = api_instance.get_fulfillment_request_id_by_sales_strategy_presales_order_id(sales_order_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling AuctionApi->get_fulfillment_request_id_by_sales_strategy_presales_order_id: %s\n" % e)
```
