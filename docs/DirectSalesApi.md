...
[**set_supply_line_assigned_number_of_pieces**](DirectSalesApi.md#set_supply_line_assigned_number_of_pieces) | **PATCH** /supply-lines/{supplyLineId}/assigned-number-of-pieces | supply:write - Update the assigned number of pieces of the supply line with type BATCH_PRICE.
[**set_supply_line_only_asap_delivery**](DirectSalesApi.md#set_supply_line_only_asap_delivery) | **PATCH** /supply-lines/{supplyLineId}/only-asap-delivery | supply:write - Update the &#x27;only asap delivery&#x27; value of the supply line with type BATCH_PRICE.
...
# **get_batch_base_supply**
> list[BatchBaseSupply] get_batch_base_supply(order_date_time)

supply:read - Returns batch base supply from all batches with an order period within the give order date time.
...
# create an instance of the API class
api_instance = floriday_supplier_client.DirectSalesApi(floriday_supplier_client.ApiClient(configuration))
order_date_time = '2013-10-20T19:20:30+01:00' # datetime | 

try:
    # supply:read - Returns batch base supply from all batches with an order period within the give order date time.
    api_response = api_instance.get_batch_base_supply(order_date_time)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DirectSalesApi->get_batch_base_supply: %s\n" % e)
```
...
> set_supply_line_assigned_number_of_pieces(body, supply_line_id)

supply:write - Update the assigned number of pieces of the supply line with type BATCH_PRICE.
...
# create an instance of the API class
api_instance = floriday_supplier_client.DirectSalesApi(floriday_supplier_client.ApiClient(configuration))
body = floriday_supplier_client.SupplyLineAssignedNumberOfPiecesUpdate() # SupplyLineAssignedNumberOfPiecesUpdate | 
supply_line_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 

try:
    # supply:write - Update the assigned number of pieces of the supply line with type BATCH_PRICE.
    api_instance.set_supply_line_assigned_number_of_pieces(body, supply_line_id)
except ApiException as e:
    print("Exception when calling DirectSalesApi->set_supply_line_assigned_number_of_pieces: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**SupplyLineAssignedNumberOfPiecesUpdate**](SupplyLineAssignedNumberOfPiecesUpdate.md)|  | 
 **supply_line_id** | [**str**](.md)|  | 
...
> set_supply_line_only_asap_delivery(body, supply_line_id)

supply:write - Update the 'only asap delivery' value of the supply line with type BATCH_PRICE.
...
# create an instance of the API class
api_instance = floriday_supplier_client.DirectSalesApi(floriday_supplier_client.ApiClient(configuration))
body = floriday_supplier_client.SupplyLineOnlyAsapDeliveryUpdate() # SupplyLineOnlyAsapDeliveryUpdate | 
supply_line_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 

try:
    # supply:write - Update the 'only asap delivery' value of the supply line with type BATCH_PRICE.
    api_instance.set_supply_line_only_asap_delivery(body, supply_line_id)
except ApiException as e:
    print("Exception when calling DirectSalesApi->set_supply_line_only_asap_delivery: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**SupplyLineOnlyAsapDeliveryUpdate**](SupplyLineOnlyAsapDeliveryUpdate.md)|  | 
 **supply_line_id** | [**str**](.md)|  | 
