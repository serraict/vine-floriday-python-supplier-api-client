...
[**edit_trade_item_availability_for_customer_offers**](CatalogPricesApi.md#edit_trade_item_availability_for_customer_offers) | **PUT** /trade-items/{tradeItemId}/availability-for-customer-offers | supply:write - rate limit: 10 per second - burst limit: 1000 - Set availabilities for a trade item customer offers that uses catalog availability
[**edit_trade_item_availability_per_week**](CatalogPricesApi.md#edit_trade_item_availability_per_week) | **PUT** /trade-items/availabilities-per-week | supply:write - Set availabilities for a trade item per week
...
[**get_trade_item_availabilities_per_week_by_sequence_number**](CatalogPricesApi.md#get_trade_item_availabilities_per_week_by_sequence_number) | **GET** /trade-items/availabilities-per-week/sync/{sequenceNumber} | supply:read - rate limit: 3.4 per second - burst limit: 1000 - Returns a list of max 1000 trade item availabilities per week starting from a specified sequence number.
[**get_trade_item_availabilities_per_week_max_sequence**](CatalogPricesApi.md#get_trade_item_availabilities_per_week_max_sequence) | **GET** /trade-items/availabilities-per-week/current-max-sequence | supply:read - Returns the maximum sequence number found in trade item availabilities per week.
...
supply:write - rate limit: 10 per second - burst limit: 1000 - Set availabilities for a trade item customer offers that uses catalog availability
...
api_instance = floriday_supplier_client.CatalogPricesApi(floriday_supplier_client.ApiClient(configuration))
trade_item_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
is_available_for_customer_offers = true # bool | 

try:
    # supply:write - rate limit: 10 per second - burst limit: 1000 - Set availabilities for a trade item customer offers that uses catalog availability
    api_instance.edit_trade_item_availability_for_customer_offers(trade_item_id, is_available_for_customer_offers)
except ApiException as e:
    print("Exception when calling CatalogPricesApi->edit_trade_item_availability_for_customer_offers: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **trade_item_id** | [**str**](.md)|  | 
 **is_available_for_customer_offers** | **bool**|  | 
...
# **edit_trade_item_availability_per_week**
> edit_trade_item_availability_per_week(body)

supply:write - Set availabilities for a trade item per week
...
# create an instance of the API class
api_instance = floriday_supplier_client.CatalogPricesApi(floriday_supplier_client.ApiClient(configuration))
body = floriday_supplier_client.EditTradeItemAvailabilityPerWeek() # EditTradeItemAvailabilityPerWeek | 

try:
    # supply:write - Set availabilities for a trade item per week
    api_instance.edit_trade_item_availability_per_week(body)
except ApiException as e:
    print("Exception when calling CatalogPricesApi->edit_trade_item_availability_per_week: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**EditTradeItemAvailabilityPerWeek**](EditTradeItemAvailabilityPerWeek.md)|  | 
...
# **get_trade_item_availabilities_per_week_by_sequence_number**
> SyncResultOfTradeItemAvailabilityPerWeek get_trade_item_availabilities_per_week_by_sequence_number(sequence_number, limit)

supply:read - rate limit: 3.4 per second - burst limit: 1000 - Returns a list of max 1000 trade item availabilities per week starting from a specified sequence number.
...
try:
    # supply:read - rate limit: 3.4 per second - burst limit: 1000 - Returns a list of max 1000 trade item availabilities per week starting from a specified sequence number.
    api_response = api_instance.get_trade_item_availabilities_per_week_by_sequence_number(sequence_number, limit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CatalogPricesApi->get_trade_item_availabilities_per_week_by_sequence_number: %s\n" % e)
```
...
[**SyncResultOfTradeItemAvailabilityPerWeek**](SyncResultOfTradeItemAvailabilityPerWeek.md)
...
> int get_trade_item_availabilities_per_week_max_sequence()

supply:read - Returns the maximum sequence number found in trade item availabilities per week.
...
try:
    # supply:read - Returns the maximum sequence number found in trade item availabilities per week.
    api_response = api_instance.get_trade_item_availabilities_per_week_max_sequence()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CatalogPricesApi->get_trade_item_availabilities_per_week_max_sequence: %s\n" % e)
```
