# swagger_client.OrderRequestsApi
...
api_instance = swagger_client.OrderRequestsApi(swagger_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = swagger_client.OrderRequestsApi(swagger_client.ApiClient(configuration))
body = swagger_client.AcceptOrderRequest() # AcceptOrderRequest | 
order_request_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
...
# create an instance of the API class
api_instance = swagger_client.OrderRequestsApi(swagger_client.ApiClient(configuration))
body = swagger_client.RejectOrderRequest() # RejectOrderRequest | 
order_request_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
