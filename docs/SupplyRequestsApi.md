# swagger_client.SupplyRequestsApi
...
api_instance = swagger_client.SupplyRequestsApi(swagger_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = swagger_client.SupplyRequestsApi(swagger_client.ApiClient(configuration))
body = swagger_client.AcceptSupplyRequestLine() # AcceptSupplyRequestLine | 
