...
class Organization(object):
    ...
    def company_gln(self, company_gln):
        ...
        :type: str
        """
        if company_gln is None:
            raise ValueError("Invalid value for `company_gln`, must not be `None`")  # noqa: E501
    ...
    def rfh_relation_id(self, rfh_relation_id):
        ...
        :type: int
        """
        if rfh_relation_id is None:
            raise ValueError("Invalid value for `rfh_relation_id`, must not be `None`")  # noqa: E501
    ...
    def rfh_company_account_id(self, rfh_company_account_id):
        ...
        :type: int
        """
        if rfh_company_account_id is None:
            raise ValueError("Invalid value for `rfh_company_account_id`, must not be `None`")  # noqa: E501
    ...
    def plantion_registration_number(self, plantion_registration_number):
        ...
        :type: int
        """
        if plantion_registration_number is None:
            raise ValueError("Invalid value for `plantion_registration_number`, must not be `None`")  # noqa: E501
