...
class Organization(object):
    ...
    def __init__(self, organization_id=None, company_gln=None, name=None, end_date=None, rfh_relation_id=None, rfh_company_account_id=None, organization_type=None, sequence_number=None, creation_date_time=None, last_modified_date_time=None, commercial_name=None, website=None, payment_providers=None, mailing_address=None, physical_address=None, plantion_registration_number=None, logo_url=None, is_fsi_compliant=None):  # noqa: E501
        ...
        self.is_fsi_compliant = is_fsi_compliant
    ...
    def payment_providers(self, payment_providers):
        ...
        if payment_providers is None:
            raise ValueError("Invalid value for `payment_providers`, must not be `None`")  # noqa: E501
    ...
    def physical_address(self, physical_address):
        ...
        if physical_address is None:
            raise ValueError("Invalid value for `physical_address`, must not be `None`")  # noqa: E501
    ...
    @property
    def is_fsi_compliant(self):
        """Gets the is_fsi_compliant of this Organization.  # noqa: E501


        :return: The is_fsi_compliant of this Organization.  # noqa: E501
        :rtype: bool
        """
        return self._is_fsi_compliant

    @is_fsi_compliant.setter
    def is_fsi_compliant(self, is_fsi_compliant):
        """Sets the is_fsi_compliant of this Organization.


        :param is_fsi_compliant: The is_fsi_compliant of this Organization.  # noqa: E501
        :type: bool
        """
        if is_fsi_compliant is None:
            raise ValueError("Invalid value for `is_fsi_compliant`, must not be `None`")  # noqa: E501

        self._is_fsi_compliant = is_fsi_compliant
