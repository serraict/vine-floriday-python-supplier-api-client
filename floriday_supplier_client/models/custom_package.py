...
class CustomPackage(object):
    ...
    attribute_map = {
        ...
        'default_pieces_per_package': 'defaultPiecesPerPackage'
    }

    def __init__(self, custom_package_id=None, code=None, name=None, description=None, photo_url=None, package_length_in_mm=None, package_width_in_mm=None, package_height_in_mm=None, package_weight_in_gram=None, fallback_vbn_package_code=None, material_type_id=None, is_deleted=None, creation_date_time=None, last_modified_date_time=None, sequence_number=None, material_type=None, floricode_vrs_packaging_id=None, default_pieces_per_package=None):  # noqa: E501
        ...
        self._default_pieces_per_package = None
        ...
        self.default_pieces_per_package = default_pieces_per_package
    ...
    def floricode_vrs_packaging_id(self):
        """Gets the floricode_vrs_packaging_id of this CustomPackage.  # noqa: E501


        :return: The floricode_vrs_packaging_id of this CustomPackage.  # noqa: E501
        :rtype: str
        """
    ...
    def floricode_vrs_packaging_id(self, floricode_vrs_packaging_id):
        """Sets the floricode_vrs_packaging_id of this CustomPackage.


        :param floricode_vrs_packaging_id: The floricode_vrs_packaging_id of this CustomPackage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def default_pieces_per_package(self):
        """Gets the default_pieces_per_package of this CustomPackage.  # noqa: E501


        :return: The default_pieces_per_package of this CustomPackage.  # noqa: E501
        :rtype: int
        """
        return self._default_pieces_per_package

    @default_pieces_per_package.setter
    def default_pieces_per_package(self, default_pieces_per_package):
        """Sets the default_pieces_per_package of this CustomPackage.


        :param default_pieces_per_package: The default_pieces_per_package of this CustomPackage.  # noqa: E501
        :type: int
        """
        if default_pieces_per_package is None:
            raise ValueError("Invalid value for `default_pieces_per_package`, must not be `None`")  # noqa: E501

        self._default_pieces_per_package = default_pieces_per_package
