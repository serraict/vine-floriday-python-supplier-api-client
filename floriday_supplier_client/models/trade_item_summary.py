...
class TradeItemSummary(object):
    ...
    def __init__(self, trade_item_id=None, supplier_article_code=None, vbn_product_code=None, trade_item_name=None, characteristics=None, photos=None, is_customer_specific=None, supplier_organization_id=None, seller_organization_id=None, is_deleted=None, parent_id=None):  # noqa: E501
