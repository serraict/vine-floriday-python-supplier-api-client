...
class CustomerTradeSettings(object):
    ...
    swagger_types = {
        ...
        'trades_exclusively_with_fsi_compliant_suppliers': 'AllOfCustomerTradeSettingsTradesExclusivelyWithFsiCompliantSuppliers',
        'sequence_number': 'int'
    }
    ...
    def __init__(self, customer_organization_id=None, accepts_direct_orders=None, automatically_accepts_correction_requests_on_direct_orders=None, automatically_accepts_correction_requests_on_supply_orders=None, allow_suppliers_to_manage_selected_trade_item_assortment=None, accepts_supply_of_type_purchase_tip=None, uses_contracts=None, accepts_transport_cost=None, trades_exclusively_with_fsi_compliant_suppliers=None, sequence_number=None):  # noqa: E501
        ...
        self._trades_exclusively_with_fsi_compliant_suppliers = None
        ...
        self.trades_exclusively_with_fsi_compliant_suppliers = trades_exclusively_with_fsi_compliant_suppliers
    ...
    @property
    def trades_exclusively_with_fsi_compliant_suppliers(self):
        """Gets the trades_exclusively_with_fsi_compliant_suppliers of this CustomerTradeSettings.  # noqa: E501

        Organization only works with suppliers that are FSI compliant.  # noqa: E501

        :return: The trades_exclusively_with_fsi_compliant_suppliers of this CustomerTradeSettings.  # noqa: E501
        :rtype: AllOfCustomerTradeSettingsTradesExclusivelyWithFsiCompliantSuppliers
        """
        return self._trades_exclusively_with_fsi_compliant_suppliers

    @trades_exclusively_with_fsi_compliant_suppliers.setter
    def trades_exclusively_with_fsi_compliant_suppliers(self, trades_exclusively_with_fsi_compliant_suppliers):
        """Sets the trades_exclusively_with_fsi_compliant_suppliers of this CustomerTradeSettings.

        Organization only works with suppliers that are FSI compliant.  # noqa: E501

        :param trades_exclusively_with_fsi_compliant_suppliers: The trades_exclusively_with_fsi_compliant_suppliers of this CustomerTradeSettings.  # noqa: E501
        :type: AllOfCustomerTradeSettingsTradesExclusivelyWithFsiCompliantSuppliers
        """
        if trades_exclusively_with_fsi_compliant_suppliers is None:
            raise ValueError("Invalid value for `trades_exclusively_with_fsi_compliant_suppliers`, must not be `None`")  # noqa: E501

        self._trades_exclusively_with_fsi_compliant_suppliers = trades_exclusively_with_fsi_compliant_suppliers
