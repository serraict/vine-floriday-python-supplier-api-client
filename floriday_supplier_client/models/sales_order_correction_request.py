...
class SalesOrderCorrectionRequest(object):
    ...
    def sales_order_version_after_correction(self, sales_order_version_after_correction):
        ...
        :type: int
        """
        if sales_order_version_after_correction is None:
            raise ValueError("Invalid value for `sales_order_version_after_correction`, must not be `None`")  # noqa: E501
    ...
    def delivery_location(self, delivery_location):
        ...
        if delivery_location is None:
            raise ValueError("Invalid value for `delivery_location`, must not be `None`")  # noqa: E501
