...
class SalesOrderCorrectionRequest(object):
    ...
    swagger_types = {
        ...
        'delivery_location': 'CorrectionDeliveryLocation',
        'additional_services': 'list[CorrectionAdditionalService]',
        'reclamation_action_decision': 'SalesOrderReclamationActionDecision'
    }
    ...
    attribute_map = {
        ...
        'incoterm': 'incoterm',
        'should_return_packages': 'shouldReturnPackages',
        'reason': 'reason',
        ...
        'reclamation_action_decision': 'reclamationActionDecision'
    }

    def __init__(self, sales_order_correction_request_id=None, sales_order_id=None, status=None, is_sales_order_created_by_supplier=None, initiated_by=None, expires_at_date_time=None, creation_date_time=None, last_modified_date_time=None, sequence_number=None, customer_organization_id=None, price_per_piece=None, delivery_price_per_piece=None, package=None, number_of_pieces=None, pieces_per_package=None, incoterm=None, should_return_packages=None, reason=None, is_cancel_request=None, sales_order_version_after_correction=None, created_by_user_name=None, stock_application=None, latest_delivery_date_time=None, delivery_location=None, additional_services=None, reclamation_action_decision=None):  # noqa: E501
        ...
        self._incoterm = None
        self._should_return_packages = None
        self._reason = None
        ...
        self._reclamation_action_decision = None
        ...
        if should_return_packages is not None:
            self.should_return_packages = should_return_packages
        ...
        if reclamation_action_decision is not None:
            self.reclamation_action_decision = reclamation_action_decision
    ...
    def delivery_price_per_piece(self):
        """Gets the delivery_price_per_piece of this SalesOrderCorrectionRequest.  # noqa: E501


        :return: The delivery_price_per_piece of this SalesOrderCorrectionRequest.  # noqa: E501
        :rtype: Price
        """
    ...
    def delivery_price_per_piece(self, delivery_price_per_piece):
        """Sets the delivery_price_per_piece of this SalesOrderCorrectionRequest.


        :param delivery_price_per_piece: The delivery_price_per_piece of this SalesOrderCorrectionRequest.  # noqa: E501
        :type: Price
        """
    ...
    @property
    def should_return_packages(self):
        """Gets the should_return_packages of this SalesOrderCorrectionRequest.  # noqa: E501


        :return: The should_return_packages of this SalesOrderCorrectionRequest.  # noqa: E501
        :rtype: bool
        """
        return self._should_return_packages

    @should_return_packages.setter
    def should_return_packages(self, should_return_packages):
        """Sets the should_return_packages of this SalesOrderCorrectionRequest.


        :param should_return_packages: The should_return_packages of this SalesOrderCorrectionRequest.  # noqa: E501
        :type: bool
        """

        self._should_return_packages = should_return_packages
    ...
    def latest_delivery_date_time(self):
        """Gets the latest_delivery_date_time of this SalesOrderCorrectionRequest.  # noqa: E501


        :return: The latest_delivery_date_time of this SalesOrderCorrectionRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def latest_delivery_date_time(self, latest_delivery_date_time):
        """Sets the latest_delivery_date_time of this SalesOrderCorrectionRequest.


        :param latest_delivery_date_time: The latest_delivery_date_time of this SalesOrderCorrectionRequest.  # noqa: E501
        :type: datetime
        """
    ...
    def delivery_location(self):
        """Gets the delivery_location of this SalesOrderCorrectionRequest.  # noqa: E501


        :return: The delivery_location of this SalesOrderCorrectionRequest.  # noqa: E501
        :rtype: CorrectionDeliveryLocation
        """
        return self._delivery_location

    @delivery_location.setter
    def delivery_location(self, delivery_location):
        """Sets the delivery_location of this SalesOrderCorrectionRequest.


        :param delivery_location: The delivery_location of this SalesOrderCorrectionRequest.  # noqa: E501
        :type: CorrectionDeliveryLocation
        """
    ...
    def additional_services(self):
        """Gets the additional_services of this SalesOrderCorrectionRequest.  # noqa: E501


        :return: The additional_services of this SalesOrderCorrectionRequest.  # noqa: E501
        :rtype: list[CorrectionAdditionalService]
        """
        return self._additional_services

    @additional_services.setter
    def additional_services(self, additional_services):
        """Sets the additional_services of this SalesOrderCorrectionRequest.


        :param additional_services: The additional_services of this SalesOrderCorrectionRequest.  # noqa: E501
        :type: list[CorrectionAdditionalService]
        """
    ...
    @property
    def reclamation_action_decision(self):
        """Gets the reclamation_action_decision of this SalesOrderCorrectionRequest.  # noqa: E501


        :return: The reclamation_action_decision of this SalesOrderCorrectionRequest.  # noqa: E501
        :rtype: SalesOrderReclamationActionDecision
        """
        return self._reclamation_action_decision

    @reclamation_action_decision.setter
    def reclamation_action_decision(self, reclamation_action_decision):
        """Sets the reclamation_action_decision of this SalesOrderCorrectionRequest.


        :param reclamation_action_decision: The reclamation_action_decision of this SalesOrderCorrectionRequest.  # noqa: E501
        :type: SalesOrderReclamationActionDecision
        """

        self._reclamation_action_decision = reclamation_action_decision
