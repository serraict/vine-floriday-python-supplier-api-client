...
class SalesOrderExternalIntegrationRequest(object):
    ...
    def __init__(self, sales_order_id=None, customer_organization_id=None, trade_item_id=None, despatch_warehouse_id=None, number_of_pieces=None, price_per_piece=None, customer_order_id=None, created_by_user=None, packing_configuration=None, delivery=None, additional_services=None, send_ekt=None, payment_provider=None, delivery_remarks=None, included_services=None):  # noqa: E501
