...
class DeliveryLocation(object):
    ...
    def __init__(self, location_id=None, organization_id=None, gln=None, address=None, is_deleted=None, is_default=None, last_modified_date_time=None, creation_date_time=None, sequence_number=None, name=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this DeliveryLocation.  # noqa: E501


        :return: The name of this DeliveryLocation.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeliveryLocation.


        :param name: The name of this DeliveryLocation.  # noqa: E501
        :type: str
        """
        if name is None:
