...
class DeliveryCondition(object):
    ...
    swagger_types = {
        ...
        'additional_costs': 'DeliveryConditionAdditionalCosts'
    }
    ...
    attribute_map = {
        ...
        'non_working_day_delivery_condition': 'nonWorkingDayDeliveryCondition',
        'has_delivery_cost': 'hasDeliveryCost',
        'additional_costs': 'additionalCosts'
    }

    def __init__(self, delivery_condition_id=None, delivery_regions=None, minimum_quantity=None, incoterm=None, delivery_condition_times=None, non_working_day_delivery_condition=None, has_delivery_cost=None, additional_costs=None):  # noqa: E501
        ...
        self.has_delivery_cost = has_delivery_cost
    ...
    def delivery_condition_times(self, delivery_condition_times):
        ...
        """
        if delivery_condition_times is None:
            raise ValueError("Invalid value for `delivery_condition_times`, must not be `None`")  # noqa: E501
    ...
    def non_working_day_delivery_condition(self, non_working_day_delivery_condition):
        ...
        """
        if non_working_day_delivery_condition is None:
            raise ValueError("Invalid value for `non_working_day_delivery_condition`, must not be `None`")  # noqa: E501

        self._non_working_day_delivery_condition = non_working_day_delivery_condition

    @property
    def has_delivery_cost(self):
        """Gets the has_delivery_cost of this DeliveryCondition.  # noqa: E501


        :return: The has_delivery_cost of this DeliveryCondition.  # noqa: E501
        :rtype: bool
        """
        return self._has_delivery_cost

    @has_delivery_cost.setter
    def has_delivery_cost(self, has_delivery_cost):
        """Sets the has_delivery_cost of this DeliveryCondition.


        :param has_delivery_cost: The has_delivery_cost of this DeliveryCondition.  # noqa: E501
        :type: bool
        """
        if has_delivery_cost is None:
            raise ValueError("Invalid value for `has_delivery_cost`, must not be `None`")  # noqa: E501

        self._has_delivery_cost = has_delivery_cost

    @property
    def additional_costs(self):
        """Gets the additional_costs of this DeliveryCondition.  # noqa: E501


        :return: The additional_costs of this DeliveryCondition.  # noqa: E501
        :rtype: DeliveryConditionAdditionalCosts
        """
        return self._additional_costs

    @additional_costs.setter
    def additional_costs(self, additional_costs):
        """Sets the additional_costs of this DeliveryCondition.


        :param additional_costs: The additional_costs of this DeliveryCondition.  # noqa: E501
        :type: DeliveryConditionAdditionalCosts
        """
