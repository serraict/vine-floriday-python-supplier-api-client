...
class AddSalesOrderCorrectionRequest(object):
    ...
    swagger_types = {
        ...
        'delivery_location': 'AddDeliveryLocation',
        'additional_services': 'list[AddSalesOrderCorrectionRequestForAdditionalService]'
    }
    ...
    def __init__(self, sales_order_correction_request_id=None, sales_order_id=None, price_per_piece=None, delivery_price_per_piece=None, package=None, number_of_pieces=None, pieces_per_package=None, incoterm=None, should_return_packages=None, reason=None, created_by_user=None, intended_for_customer_user=None, is_cancel_request=None, created_by_user_name=None, stock_application=None, expires_at_date_time=None, latest_delivery_date_time=None, delivery_location=None, additional_services=None):  # noqa: E501
        ...
        if expires_at_date_time is not None:
    ...
    def delivery_price_per_piece(self):
        """Gets the delivery_price_per_piece of this AddSalesOrderCorrectionRequest.  # noqa: E501


        :return: The delivery_price_per_piece of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :rtype: Price
        """
    ...
    def delivery_price_per_piece(self, delivery_price_per_piece):
        """Sets the delivery_price_per_piece of this AddSalesOrderCorrectionRequest.


        :param delivery_price_per_piece: The delivery_price_per_piece of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :type: Price
        """
    ...
    def should_return_packages(self):
        """Gets the should_return_packages of this AddSalesOrderCorrectionRequest.  # noqa: E501

        This field is not implemented yet. Determines whether the packages are returned to the supplier; in previous API versions, the default value was true. Can only be used when the sales order correction request is a cancellation request.  # noqa: E501

        :return: The should_return_packages of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def should_return_packages(self, should_return_packages):
        """Sets the should_return_packages of this AddSalesOrderCorrectionRequest.

        This field is not implemented yet. Determines whether the packages are returned to the supplier; in previous API versions, the default value was true. Can only be used when the sales order correction request is a cancellation request.  # noqa: E501

        :param should_return_packages: The should_return_packages of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :type: bool
        """
    ...
    def expires_at_date_time(self):
        """Gets the expires_at_date_time of this AddSalesOrderCorrectionRequest.  # noqa: E501

        Date time on which the sales order correction expires. By default, the expiry date is set to the next workday at 18:00.  # noqa: E501

        :return: The expires_at_date_time of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expires_at_date_time(self, expires_at_date_time):
        """Sets the expires_at_date_time of this AddSalesOrderCorrectionRequest.

        Date time on which the sales order correction expires. By default, the expiry date is set to the next workday at 18:00.  # noqa: E501

        :param expires_at_date_time: The expires_at_date_time of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :type: datetime
        """
    ...
    def latest_delivery_date_time(self):
        """Gets the latest_delivery_date_time of this AddSalesOrderCorrectionRequest.  # noqa: E501


        :return: The latest_delivery_date_time of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def latest_delivery_date_time(self, latest_delivery_date_time):
        """Sets the latest_delivery_date_time of this AddSalesOrderCorrectionRequest.


        :param latest_delivery_date_time: The latest_delivery_date_time of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :type: datetime
        """
    ...
    def delivery_location(self):
        """Gets the delivery_location of this AddSalesOrderCorrectionRequest.  # noqa: E501


        :return: The delivery_location of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :rtype: AddDeliveryLocation
        """
        return self._delivery_location

    @delivery_location.setter
    def delivery_location(self, delivery_location):
        """Sets the delivery_location of this AddSalesOrderCorrectionRequest.


        :param delivery_location: The delivery_location of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :type: AddDeliveryLocation
        """
    ...
    def additional_services(self):
        """Gets the additional_services of this AddSalesOrderCorrectionRequest.  # noqa: E501


        :return: The additional_services of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :rtype: list[AddSalesOrderCorrectionRequestForAdditionalService]
        """
        return self._additional_services

    @additional_services.setter
    def additional_services(self, additional_services):
        """Sets the additional_services of this AddSalesOrderCorrectionRequest.


        :param additional_services: The additional_services of this AddSalesOrderCorrectionRequest.  # noqa: E501
        :type: list[AddSalesOrderCorrectionRequestForAdditionalService]
        """
