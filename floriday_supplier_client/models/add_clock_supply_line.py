...
class AddClockSupplyLine(object):
    ...
    def __init__(self, batch_id=None, auction_date=None, auction_remark=None, minimum_price_per_piece=None, number_of_pieces=None, auction_group_code=None, supply_line_id=None, clock_presales=None, photos=None):  # noqa: E501
    ...
    def clock_presales(self, clock_presales):
        ...
        """
        if clock_presales is None:
            raise ValueError("Invalid value for `clock_presales`, must not be `None`")  # noqa: E501
