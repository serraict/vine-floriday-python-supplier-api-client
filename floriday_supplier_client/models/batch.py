...
class Batch(object):
    ...
    def __init__(self, batch_date=None, batch_id=None, trade_item_id=None, supplier_organization_id=None, number_of_pieces=None, initial_number_of_pieces=None, packing_configuration=None, warehouse_id=None, image_url=None, batch_reference=None, custom_reference=None, sequence_number=None, transit_status=None, trade_item_version=None, is_deleted=None, creation_date_time=None, last_modified_date_time=None):  # noqa: E501
    ...
    def transit_status(self, transit_status):
        ...
        :type: TransitStatus
        """
        if transit_status is None:
            raise ValueError("Invalid value for `transit_status`, must not be `None`")  # noqa: E501
