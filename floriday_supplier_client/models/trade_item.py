...
class TradeItem(object):
    ...
    def __init__(self, trade_item_id=None, seller_organization_id=None, supplier_article_code=None, article_gtin=None, vbn_product_code=None, trade_item_name=None, characteristics=None, customer_organization_ids=None, seasonal_periods=None, photos=None, packing_configurations=None, botanical_names=None, country_of_origin_iso_codes=None, is_hidden_in_catalog=None, sequence_number=None, is_parent_for_variant=None, parent_id=None, trade_item_components=None, trade_item_reference=None, trade_item_version=None, creation_date_time=None, last_modified_date_time=None, is_deleted=None, has_invalid_floricode_data=None, additional_packaging_information_floricode_vrs_packaging_ids=None):  # noqa: E501
        ...
        self._additional_packaging_information_floricode_vrs_packaging_ids = None
        ...
        if additional_packaging_information_floricode_vrs_packaging_ids is not None:
            self.additional_packaging_information_floricode_vrs_packaging_ids = additional_packaging_information_floricode_vrs_packaging_ids
    ...
    def seller_organization_id(self):
        """Gets the seller_organization_id of this TradeItem.  # noqa: E501


        :return: The seller_organization_id of this TradeItem.  # noqa: E501
        :rtype: str
        """
    ...
    def seller_organization_id(self, seller_organization_id):
        """Sets the seller_organization_id of this TradeItem.


        :param seller_organization_id: The seller_organization_id of this TradeItem.  # noqa: E501
        :type: str
        """
        if seller_organization_id is None:
            raise ValueError("Invalid value for `seller_organization_id`, must not be `None`")  # noqa: E501
    ...
    def is_parent_for_variant(self, is_parent_for_variant):
        ...
        :type: bool
        """
        if is_parent_for_variant is None:
            raise ValueError("Invalid value for `is_parent_for_variant`, must not be `None`")  # noqa: E501
    ...
    @property
    def additional_packaging_information_floricode_vrs_packaging_ids(self):
        """Gets the additional_packaging_information_floricode_vrs_packaging_ids of this TradeItem.  # noqa: E501


        :return: The additional_packaging_information_floricode_vrs_packaging_ids of this TradeItem.  # noqa: E501
        :rtype: list[str]
        """
        return self._additional_packaging_information_floricode_vrs_packaging_ids

    @additional_packaging_information_floricode_vrs_packaging_ids.setter
    def additional_packaging_information_floricode_vrs_packaging_ids(self, additional_packaging_information_floricode_vrs_packaging_ids):
        """Sets the additional_packaging_information_floricode_vrs_packaging_ids of this TradeItem.


        :param additional_packaging_information_floricode_vrs_packaging_ids: The additional_packaging_information_floricode_vrs_packaging_ids of this TradeItem.  # noqa: E501
        :type: list[str]
        """

        self._additional_packaging_information_floricode_vrs_packaging_ids = additional_packaging_information_floricode_vrs_packaging_ids
