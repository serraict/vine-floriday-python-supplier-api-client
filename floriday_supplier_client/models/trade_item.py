...
class TradeItem(object):
    ...
    def additional_packaging_information_floricode_vrs_packaging_ids(self, additional_packaging_information_floricode_vrs_packaging_ids):
        ...
        :type: list[str]
        """
        if additional_packaging_information_floricode_vrs_packaging_ids is None:
            raise ValueError("Invalid value for `additional_packaging_information_floricode_vrs_packaging_ids`, must not be `None`")  # noqa: E501
