...
class DeliveryConditionSet(object):
    ...
    attribute_map = {
        ...
        'delivery_condition_set_commercial_name': 'deliveryConditionSetCommercialName',
    ...
    def __init__(self, delivery_condition_set_id=None, delivery_condition_set_name=None, delivery_condition_set_commercial_name=None, warehouse_ids=None, customers=None, delivery_conditions=None, is_deleted=None, is_customer_specific=None, sequence_number=None, version=None):  # noqa: E501
        ...
        self._delivery_condition_set_commercial_name = None
        ...
        self.delivery_condition_set_commercial_name = delivery_condition_set_commercial_name
    ...
    @property
    def delivery_condition_set_commercial_name(self):
        """Gets the delivery_condition_set_commercial_name of this DeliveryConditionSet.  # noqa: E501


        :return: The delivery_condition_set_commercial_name of this DeliveryConditionSet.  # noqa: E501
        :rtype: str
        """
        return self._delivery_condition_set_commercial_name

    @delivery_condition_set_commercial_name.setter
    def delivery_condition_set_commercial_name(self, delivery_condition_set_commercial_name):
        """Sets the delivery_condition_set_commercial_name of this DeliveryConditionSet.


        :param delivery_condition_set_commercial_name: The delivery_condition_set_commercial_name of this DeliveryConditionSet.  # noqa: E501
        :type: str
        """
        if delivery_condition_set_commercial_name is None:
            raise ValueError("Invalid value for `delivery_condition_set_commercial_name`, must not be `None`")  # noqa: E501

        self._delivery_condition_set_commercial_name = delivery_condition_set_commercial_name
